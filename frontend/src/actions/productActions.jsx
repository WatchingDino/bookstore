...
export const getAdminProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${import.meta.env.VITE_APP_API}/api/v1/admin/products`,
      {
...
export const newProduct = (productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${import.meta.env.VITE_APP_API}/api/v1/admin/product/new`,
      productData,
      config
    );
    dispatch({
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${import.meta.env.VITE_APP_API}/api/v1/admin/product/${id}`,
      {
        withCredentials: true, //correct
      }
    );
...
export const getProductReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${import.meta.env.VITE_APP_API}/api/v1/reviews?id=${id}`,
      config
    );
    dispatch({
...
export const deleteReview = (id, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${import.meta.env.VITE_APP_API}/api/v1/reviews?id=${id}&productId=${productId}`,
      { withCredentials: true }
    );
    dispatch({
